...
//both age and extension are numbers. a and b are number types. T for generic objects, colleague/friend both apply.
function sort<T>(data: T[], match: (a:T, b:T) => number):T[]{
    return data.sort(match)
}
